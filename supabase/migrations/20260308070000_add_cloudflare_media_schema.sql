...
INSERT INTO public.resources_registry (name, display_name, description, scope, db_table, permission_prefix, icon, is_system)
VALUES 
('Media Library', 'Media Objects', 'Storage media tracking', 'tenant', 'media_objects', 'tenant.media', 'Image', false)
